...
print ("\n---------------------------fill a single column with null value using user input---------------------------\n")

user1 = input("what column with NaN do you want to fill: ")
user2 = input("what value do you want to fill for null: ")

print (data[user1].fillna(user2))

print ("\n---------------------------fill null value with user input---------------------------\n")

user3 = input("what value do you want to fill for null: ")

print (data.fillna(user3))